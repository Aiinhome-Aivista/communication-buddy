...
function Login() {
    ...
    return (
        ...
        >
            {/* Top Logo */}
            <p className="font-baloo w-full flex text-base md:text-lg">
                Ai<span className="text-[#DFB916]">in</span>home
        ...
        "
            >
                ...
                <div className="w-full md:w-1/2 h-full flex flex-col mb-6 md:mb-0">
                    <div className="font-baloo flex flex-col w-full h-auto pl-4 md:pl-6 pt-4 md:pt-6">
